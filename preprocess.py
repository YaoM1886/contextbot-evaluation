...
def check_behavior_response(total_df):
    ...
    # id-378 just clicked the contextbot icon, and we think we should not use the liars because the execution time is not exactly what we want

    failed_behavior_response_id = [37, 108, 123, 204, 220, 266, 282, 283, 340, 378]
