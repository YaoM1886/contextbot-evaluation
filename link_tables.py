...
#TODO: 1. preprocess the data again and get the whole new dataset
#      2. calculate user experience score based on the manual
...
worker_df = pd.read_csv("/Users/sylvia/Documents/Netherlands/Course/MasterThesis/Experiments/data/worker.csv")
behavior_df = pd.read_csv("/Users/sylvia/Documents/Netherlands/Course/MasterThesis/Experiments/data/behavior.csv")
message_df = pd.read_csv("/Users/sylvia/Documents/Netherlands/Course/MasterThesis/Experiments/data/message.csv")
time_df = pd.read_csv("/Users/sylvia/Documents/Netherlands/Course/MasterThesis/Experiments/data/time.csv")
pre_survey = pd.read_csv("/Users/sylvia/Documents/Netherlands/Course/MasterThesis/Experiments/data/pre_survey.csv", usecols=["Q10_1", "Q7"])[2:]
post_survey = pd.read_csv("/Users/sylvia/Documents/Netherlands/Course/MasterThesis/Experiments/data/post_survey.csv", usecols=["Q7", "Q9", "Q6_1", "Q6_2", "Q6_3", "QID1_1", "QID1_2", "QID1_3", "QID1_4", "QID1_5", "QID1_6", "QID1_7", "QID1_8",                                                                                                                           "Q10", "Q2_1", "Q2_2", "Q2_3", "Q2_4", "Q2_5", "Q2_6", "Q2_7", "Q2_8", "Q11", "Q3_1", "Q3_2", "Q3_3", "Q3_4", "Q3_5", "Q3_6","Q4_1", "Q5", "Q12", "Q12", "TASK_TYPE"])[2:]


 # rename columns of the survey
pre_survey.rename(columns={"Q10_1": "mood", "Q7": "prolific_id"}, inplace=True)
post_survey.rename(columns={"Q7":"prolific_id", "Q9": "interacted", "Q6_1":"familiar_tech", "Q6_2":"use_freq", "Q6_3":"get_help", "QID1_1":"explain_cxt", "QID1_2":"cxt_flow", "QID1_3": "reply_btn", "QID1_4": "feel_control", "QID1_5":"ling_cxt", "QID1_6": "seman_cxt", "QID1_7": "attent_check1", "QID1_8": "cogn_cxt", "Q10": "comment_contextbot", "Q11": "attent_check2", "Q4_1":"satis_score", "Q5":"comment_system", "Q12":"preporgrammed"}, inplace=True)
...
def check_behavior_response(total_df):
    ...
    print("Reject participants who failed to be honest about the interaction: ", worker_df[worker_df["id"].isin(failed_behavior_response_id)])
...
def check_utterance(total_df):
    ...
    print("\nTotal number of qualified participants: ", len(utterance_df["id"].unique()))
...
if __name__ == "__main__":
    ...
    total_df = check_utterance(total_df)
    ...
    print(behavior_df[behavior_df["w_id"]==220])
